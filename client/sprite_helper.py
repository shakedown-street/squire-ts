...
heavy_armor_sword_shield = {
    "idle": {
        "duration": 100,
        "frames": generate_frame_list(0, 1045, 96, 96, 35, 45, 8, 10)
    },
    "walk": {
        "duration": 125,
        "frames": generate_frame_list(2882, 1045, 96, 96, 35, 45, 8, 8)
    },
    "hit": {
        "duration": 40,
        "frames": generate_frame_list(4420, 1045, 96, 96, 40, 45, 8, 6)
    },
    "attack": {
        "duration": 62.5,
        "frames": generate_frame_list(0, 7, 128, 128, 50, 77, 8, 16)
    },
    "die": {
        "duration": 50,
        "frames": generate_frame_list(2049, 7, 128, 96, 60, 50, 8, 20)
    },
    "magic_lightning": {
        "duration": 50,
        "frames": generate_frame_list(1921, 1827, 96, 96, 35, 45, 8, 20)
    }
}
...
coins = {
    "drop": {
        "duration": 100,
        "frames": generate_frame_list(0, 3919, 96, 160, 0, 0, 1, 10)
    }
}
