...
export class HeavyArmorSwordShield extends AnimationDef {
  ...
  public animations = {
    walk: {
      duration: 120,
      frames: [
        [0, 0, 2911 - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [1, 0, 2911 + (96) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [2, 0, 2911 + (96 * 2) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [3, 0, 2911 + (96 * 3) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [4, 0, 2911 + (96 * 4) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [5, 0, 2911 + (96 * 5) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [6, 0, 2911 + (96 * 6) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [7, 0, 2911 + (96 * 7) - (58 / 2), 1093 - (79 / 2), 58, 79, 0, 0],
        [0, 1, 2916, 1186, 44, 85, 0, 0],
        [1, 1, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 1, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 1, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 1, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 1, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 1, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 1, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 2, 2916, 1186, 44, 85, 0, 0],
        [1, 2, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 2, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 2, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 2, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 2, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 2, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 2, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 3, 2916, 1186, 44, 85, 0, 0],
        [1, 3, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 3, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 3, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 3, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 3, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 3, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 3, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 4, 2916, 1186, 44, 85, 0, 0],
        [1, 4, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 4, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 4, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 4, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 4, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 4, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 4, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 5, 2916, 1186, 44, 85, 0, 0],
        [1, 5, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 5, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 5, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 5, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 5, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 5, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 5, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 6, 2916, 1186, 44, 85, 0, 0],
        [1, 6, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 6, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 6, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 6, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 6, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 6, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 6, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
        [0, 7, 2916, 1186, 44, 85, 0, 0],
        [1, 7, 2916 + (96), 1186, 44, 85, 0, 0],
        [2, 7, 2916 + (96 * 2), 1186, 44, 85, 0, 0],
        [3, 7, 2916 + (96 * 3), 1186, 44, 85, 0, 0],
        [4, 7, 2916 + (96 * 4), 1186, 44, 85, 0, 0],
        [5, 7, 2916 + (96 * 5), 1186, 44, 85, 0, 0],
        [6, 7, 2916 + (96 * 6), 1186, 44, 85, 0, 0],
        [7, 7, 2916 + (96 * 7), 1186, 44, 85, 0, 0],
      ]
    }
  };
}
