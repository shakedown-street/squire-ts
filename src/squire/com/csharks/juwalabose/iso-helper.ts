...
export class IsoHelper {
  ...
  public static isoTo2D(pt: Point2d) {
    let tempPt = new Point2d(0, 0);
  ...
  public static twoDToIso(pt: Point2d) {
    let tempPt = new Point2d(0, 0);
    tempPt.x = pt.x - pt.y;
  ...
  public static getTileCoordinates(pt: Point2d, tileHeight: number) {
  ...
  public static get2dFromTileCoordinates(pt: Point2d, tileHeight: number) {
    let tempPt: Point2d = new Point2d(0, 0);
